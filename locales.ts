...
export const translations = {
  ...
  en: {
    ...
    btn_reload: 'Reload and Re-detect',
    btn_reconnect: 'Return to Source',
    btn_details: 'Details',
    ...
    browser_screen: 'Screen Size',
    browser_dpr: 'Pixel Ratio',
  ...
  ja: {
    ...
    btn_reload: 'ページを更新して再検出',
    btn_reconnect: '元のサイトに戻る',
    btn_details: '詳細情報',

    sys_info: 'システム情報',
    curr_browser: '現在のブラウザ',

    browser_ua: 'ユーザーエージェント',
    browser_lang: '言語',
    browser_cookie: 'Cookie',
    browser_screen: '画面サイズ',
    browser_dpr: '比率',
    cookie_enabled: '有効',
    cookie_disabled: '無効',
  }
